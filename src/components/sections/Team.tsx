    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            bio: 'Sou Jamille Mota, psicóloga de ofício, Coordenadora ABA por função, Analista do comportamento por formação. Quando comecei, o caminho era estreito, Mais pedra que chão. Fui AT quando quase não havia trilha, Quando inclusão era palavra sem vez. Aprendi cedo que toda criança tem a dizer e que comportamento é comunicação. Busquei a ciência onde ela se renova, Cruzei fronteiras para poder aprender:PRT, SBT, HRE, CAA Ferramentas que ampliam a intervenção Não acredito em caso perdido. Onde muitos veem limite, Eu investigo função.Onde dizem “não dá”, Aprendi em supervisão a reorganizar o ambiente, Ajustar o ensino, Sustentar o vínculo e seguir com intenção. Meu lugar clínico é com quem mais precisa, Casos nível 3 de suporte, Onde o ensino exige assentimentoE a técnica, compaixão.Porque ciência que transforma, acolhe. E afeto não é ausência de rigor: É o que mantém o ensino de pé E dá vigor. Trabalho com dados, gráficos e planos de intervenção, Mas nenhum protocolo está acima Da história que se viveNem do bem-estar de quem aprende. Intervir, para mim, Não é silenciar comportamento, É ampliar repertóriosSem apagar quem a criança é. Sou psicóloga. Sou analista do comportamento. Sou fruto de um caminho de estudo e dedicação E defensora de uma prática clara:onde há ciência, há transformação. onde há afeto, há direção. e onde há compaixão, o desenvolvimento acontece.',
          },
          {
