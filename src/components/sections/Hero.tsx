        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-8 text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
              Na <span className="text-yellow-600 font-bold">Beehave</span>, ofertamos uma variedade de serviços em ABA por meio de duas linhas organizacionais entrelaçadas: a Beehave Serviços e a Beehave Cursos. Trabalhamos com <span className="italic">Afeto, Ciência e Ética</span>.
            </p>
